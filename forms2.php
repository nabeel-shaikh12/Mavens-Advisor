                    ...
                    <div class="formbold-form-step-1 active">
                        ...
                        <div class="form-group" id="serviceContainer">
                            ...
                            <select id="businessCategory" name="business_category" class="product_select formbold-form-input" style="display: none;">
                                <option data-display="1. Select an option">Select an option</option>
                        ...
                        <div class="formbold-form-btn-wrapper">
                            <button type="submit" class="formbold-btn" name="Subscribe">Submit</button>
...
<script>
    ...
    document.getElementById("businessCategory").addEventListener("change", showSubCategories);
    document.getElementById("business-typing").addEventListener("change", showSubCategories);
    document.getElementById("yearDropdown").addEventListener("change", showSubCategories);
    document.getElementById("businessType").addEventListener("change", showSubCategories);
    ...
    document.getElementById("business-size").addEventListener("change", showSubCategories);
    ...
    function showSubCategories() {
        ...
        if (mainCategory !== "Select an option") {
            ...
            businessSizeLabel.addEventListener("animationend", function() {
                BusinessService();
            }, {
                once: true
            });
        ...
        if (BusinessCategory !== "Select an option") {
            currencyLabel.style.display = "block";
            currencyLabel.style.animation = "slideInLeft 1.5s ease";

            currencyLabel.addEventListener("animationend", function() {
                CurrencyTyping();
            }, {
                once: true
            });
    ...
    document.getElementById("business_name").addEventListener("input", function() {
        ...
        if (this.value.trim() !== "") {
            ...
            FirstNameLabel.addEventListener("animationend", function() {
                FirstName();
            }, {
                once: true
            });
    ...
    function CurrencyTyping() {
        ...
        const text = "Could you please provide your currency?";
