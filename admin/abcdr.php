...
if ($result->num_rows > 0) {
    ...
    echo '<div class="form-check custom-checkbox">
	      ...
	      <label class="form-check-label" for="customCheckBox1">'.$row['email_address'].'</label>
		  </div>
	...
	echo '<div class="icon-box icon-box-sm bg-primary-light">
		    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	echo '<div class="sub-card draggable-handle draggable">
			<div class="d-items">
