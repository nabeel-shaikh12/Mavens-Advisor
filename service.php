            ...
            <div class="slider-area slider-style-1 bg-transparent variation-2 height-750 particles_css">
                <div class="container">
                    <div class="row" style="display:flex;justify-content:center;align-items:center">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xl-6 order-1 order-lg-2" data-sal="slide-left" data-sal-duration="1000" data-sal-delay="500">
                            <div class="thumbnail">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                            <div class="service-card">
                                ...
                                <a href="./form"><img style="height: 300px;" src="img/art-1.png" alt="card Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                            <div class="service-card">
                                ...
                                <a href="./form"><img style="height: 300px;" src="img/invoicing.png" alt="card Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">
                            <div class="service-card">
                                ...
                                <a href="./form"><img style="height: 300px;" src="img/men-art.png" alt="card Images"></a>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:100px !important">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                            <div class="service-card">
                                ...
                                <a href="./form"><img style="height: 300px;" src="img/payment.png" alt="card Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="200">
                            <div class="service-card">
                                ...
                                <a href="./form"><img style="height: 300px;" src="img/record.png" alt="card Images"></a>
                            </div>
                        </div>
                        <div class="row" style="margin-top:100px !important">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                                <div class="service-card">
                                    ...
                                    <a href="./form"><img style="height: 300px;" src="img/profit-loss.png" alt="card Images"></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                                <div class="service-card">
                                    ...
                                    <a href="./form"><img style="height:300px" src="img/analysis.png" alt="card Images"></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                                <div class="service-card">
                                    ...
                                    <a href="./form"><img style="height:300px" src="img/forcast.png" alt="card Images"></a>
                                </div>
                            </div>
                            <div class="row" style="margin-top:100px !important">
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                                    <div class="service-card">
                                        ...
                                        <a href="./form"><img style="height: 300px;" src="img/tax-filing.png" alt="card Images"></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                                    <div class="service-card">
                                        ...
                                        <a href="./form"><img style="height: 300px;" src="img/advice.png" alt="card Images"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
