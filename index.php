...
<body>
    ...
    <div class="smooth-scroll" data-scroll-container>
        <div class="section-wrapper" data-scroll-section>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="nb__section-subtitle mb-10">
                                <h4 class="has_text_reveal_anim">AI-driven processes</h4>
                            </div>
                            <div class="nb__section-title">
                                <h2 class="has_char_anim">Why Choose VirSME?</h2>
                            </div>
                        </div>
                    ...
                    <div class="nb__project-content mt-90 position-relative case-study-box">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="nb__project-info pl-35">
                                    <div class="nb__project-title mb-15">
                                        <a href="#">AI-Driven Efficiency</a>
                                    </div>
                                    <div class="nb__project-details pera-content">
                                        <p>Our AI solutions deliver accuracy and speed, freeing up your time to focus on growing your business.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row pb-40 nb__project-row case-study-single mt-30 has_fade_anim" data-case="case-2">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="nb__project-info pl-35">
                                    <div class="nb__project-title mb-15">
                                        <a href="#">Fixed Subscription-Based Pricing</a>
                                    </div>
                                    <div class="nb__project-details pera-content">
                                        <p>No hidden fees-our fixed pricing lets you know exactly what you'll pay, with an easy-to-use calculator for your monthly cost.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row pb-40 nb__project-row case-study-single mt-30 has_fade_anim" data-case="case-3">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="nb__project-info pl-35">
                                    <div class="nb__project-title mb-15">
                                        <a href="#">One-Window Solution</a>
                                    </div>
                                    <div class="nb__project-details pera-content">
                                        <p>VirSME brings all essential business services together on one platform, eliminating the need for multiple providers.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="nb__service-section pb-150">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="nb__section-subtitle mb-10">
                                <h4 class="has_text_reveal_anim">How VirSME Works</h4>
                            </div>
                            <div class="nb__section-title">
                                <h2 class="has_char_anim">Getting started with VirSME is simple and hassle-free</h2>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="nb__service-content">
                                    <div class="nb__service-title-with-icon">
                                        ...
                                        <div class="nb__service-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="65" height="65" style="color: white;" viewBox="0 0 65 65"
                                                fill="none">
                                                <path
                                    ...
                                    <div class="nb__service-info pera-content">
                                        <p>Browse through our wide range of offerings to see how we can meet your business needs.</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-1 col-md-6 col-lg-6 col-xl-4 nb__service-column" data-scroll data-scroll-speed="0.8">
                            <div class="nb__service-box">
                                <div class="nb__service-content">
                                    <div class="nb__service-title-with-icon">
                                        <div class="nb__service-title">
                                            <a href="#">Use our Online Calculator</a>
                                        </div>
                                        <div class="nb__service-icon">
                                    ...
                                    <div class="nb__service-info pera-content">
                                        <p>Enter your business details into our online subscription calculator to get an instant, transparent quote for your monthly costs.</p>
                                    </div>
                                </div>
                                <div class="nb__service-img nb_common_img" data-scroll data-scroll-speed="0">
                        ...
                        <div class="col-sm-1 col-md-6 col-lg-6 col-xl-4 nb__service-column" data-scroll data-scroll-speed="1">
                            <div class="nb__service-box">
                                <div class="nb__service-content">
                                    ...
                                    <div class="nb__service-info pera-content">
                                        <p>With VirSME managing your essential operations, you can focus on what you do best-growing your business.</p>
                                    </div>
                                </div>
                                <div class="nb__service-img nb_common_img" data-scroll data-scroll-speed="0">
            ...
            <!-- Counter Section End -->
            <section class="nbv2_project nb-bg1 nb-pb146  nb-malls" style="margin-bottom: 200px">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6 col-xl-6 col-xxl-6 col-md-12 col-sm-12">
                                    <div class="nbv2_featured_top_left">
                                        <h4 class="nb-ls nb-f18 nb-fw7 nb-mcl nb-ffh text-uppercase has_text_reveal_anim">Our Services <i
                        ...
                        <div class="nbv2_project_wrapper_slider_main">
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/7.webp" alt="" style="height: 260px; width: 100%">
                                    <img src="assets/images/7.webp" alt="" style="height: 260px; width: 100%">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            ...
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Bookkeeping and Accounting</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/8.jpg" alt="" style="height: 260px; width: 100%"><img src="assets/images/8.jpg" style="height: 260px; width: 100%" alt="">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37 nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Financial Management & Analysis</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    ...
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            ...
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Strategic Advice</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/secretarial-services.jpg" alt="" style="height: 260px; width: 100%"> <img src="assets/images/secretarial-services.jpg" style="height: 260px; width: 100%" alt="">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37 nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Secretarial Services</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/22.jpg" alt="" style="height: 260px; width: 100%"> <img src="assets/images/22.jpg" alt="" style="height: 260px; width: 100%">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37  nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Human Resource (HR) Solutions</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/website-development.jpg" style="height: 260px; width: 100%" alt=""> <img src="assets/images/website-development.jpg" style="height: 260px; width: 100%" alt="">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37  nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Website and Software Development</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/it-support.jpg" alt="" style="height: 260px; width: 100%"> <img src="assets/images/it-support.jpg" alt="" style="height: 260px; width: 100%">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37  nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">IT Support</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/customer-support.jpg" alt="" style="height: 260px; width: 100%"> <img src="assets/images/customer-support.jpg" alt="" style="height: 260px; width: 100%">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37  nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Customer Support</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="nbv2_project_slide_single nb-iefmain">
                                <div class="nbv2_project_slide_content position-relative nb-ief ">
                                    <img src="assets/images/15.jpg" alt="" style="height: 260px; width: 100%"> <img src="assets/images/15.jpg" alt="" style="height: 260px; width: 100%">
                                    <div class="nbv2_project_slide_content_bottom_main position-absolute">
                                        <div class="nbv2_project_slide_content_bottom nb-bg2 position-relative m-auto">
                                            <div class="slider_icon">
                                                <i class="nb_icon  nb_icon-line nb-f37  nb-mcl nb-nb_icon-line"></i>
                                            </div>
                                            <h4 class="nb-f18 nb-fw7 nb-wcl nb-ffh text-capitalize">Digital Marketing and Analysis</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-5 col-lg-5 offset-xl-1 offset-lg-1 ">
                            ...
                            <div class="nb__about-features mt-40">
                                <div class="nb__about-item d-flex">
                                    <div class="nb__about-feature-number" style="color: white">01</div>
                                ...
                                <div class="nb__about-item d-flex mt-30">
                                    <div class="nb__about-feature-number has_fade_anim" style="color: white">02</div>
                                    <div class="nb__about-feature-details d-flex flex-column pera-content has_fade_anim">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Ava.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Marwa.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Marwa</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/sarwach.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Omar</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Nikhil.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Nikhil</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Ted.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Ted</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/amy-zhang.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Amy Zhang</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/amy-walls.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Amy Walls</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/nividia.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Nivida</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Gareth.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Gareth</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/seth.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Seth Cooper</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/philip.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Dasia.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Dasia</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Susie.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Susie</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Jason.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Jason</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Ori.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Ori</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Jordan.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Derek.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Derek</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Khurram.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Khurram</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/ryan.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Ryan Ackerman</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/alana-fiks.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Alana Fiks</h2>
                                                <div class="nb__testimonial-comment pera-content text-center nb_mt-5">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Osato.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Osato O</h2>
                                                <p class="nb_mt-5">Kami Studios</p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nb__testimonial-member">
                                            <img src="assets/images/Izzy.jpg" alt="testimonial author" class="rounded-1">
                                            <div
                                                class="nb__testimonial-info pera-content d-flex align-items-center flex-column mt-30">
                                                <h2>Izzy Traub</h2>
                                                <!-- <p class="nb_mt-5">Irvinei</p> -->
