        ...
        <div class="col-sm-6 col-lg-6 col-md-6 col-xl-6">
          <div class="service gallery-style">
            ...
            <form action="./database_operations/calculator_operations.php" method="POST" id="calculatorForm">
              <br>
              <label>
                <input type="checkbox" class="checkbox-custom" name="category" value="monthlyTransaction" onclick="showInputBox('monthlyTransaction')">
                Number of Monthly Transactions
              </label>
              <br>
              <div id="monthlyTransactionInput" style="display: none;">
                <input type="number" class="form-control" id="monthlyTransactionInputField" placeholder="Number of Transactions" class="p-4" oninput="calculatePrices()" min="0">
                <br>
              ...
              <br>
              <label>
                <input type="checkbox" name="category" value="monthlyInvoices" onclick="showInputBox('monthlyInvoices')">Number of Monthly Invoices
              </label>
              <br>
              ...
              <br>
              <label>
                <input type="checkbox" name="category" value="cashflow" id="cashflowCheckbox" onclick="showInputBox('cashflow')" min="0">
                Monthly cashflow
              </label>
              <br>
              ...
              <br>
              <label>
                <input type="checkbox" name="category" value="budget" id="budgetCheckbox" onclick="showInputBox('budget')" min="0">
                Monthly Budgeting
              </label>
              <br>
              ...
              <br>
              <label>
                <input type="checkbox" name="category" value="setup" id="setupCheckbox" onclick="showInputBox('setup')" min="0">
